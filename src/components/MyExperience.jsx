...
const MyExperience = () => {
    return (
        <section className="experience border">
            ...
            <div className="row justify-content-evenly gy-4 mt-3">
                ...
                <div className="col-md-4 p-3 expdiv shadow border-top border-5 rounded-4">
                    ...
                    <div className="d-flex justify-content-center align-items-center mb-4">
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">HTML</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">CSS</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">Bootstrap</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">JavaScript</small>
                        </div>
                    </div>
                    <div className="d-flex justify-content-center align-items-center mb-4">
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">React JS</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">Redux</small>
                        </div>
                        <div className="d-flex flex-column">
                            <img className="img-fluid mx-3 zustand" src={zustand} alt="zustand" />    
                            <small className="text-center text-secondary fw-bold">Zustand</small>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-4 p-3 expdiv shadow border-top border-5 rounded-4">
                    ...
                    <div className="d-flex justify-content-center align-items-center mb-4">
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">Node JS</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">Express JS</small>
                        </div>
                        <div className="d-flex flex-column align-self-end">
                            <img className="img-fluid mx-3 php" src="https://www.php.net/images/logos/new-php-logo.png" alt="php" />
                            <small className="text-center text-secondary fw-bold mt-2">PHP</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">Java</small>
                        </div>
                    </div>
                    <div className="d-flex justify-content-center align-items-center mb-4">
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">Mongo DB</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">MySQL</small>
                        </div>
                        <div className="d-flex flex-column">
                            <img className="img-fluid mx-3 abap" src={sapabap} alt="sap abap" />    
                            <small className="text-center text-secondary fw-bold">ABAP</small>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-4 p-3 expdiv shadow border-top border-5 rounded-4 mb-5">
                    <div className="d-flex justify-content-between align-items-center mb-5">
                        <div className="d-flex justify-content-start">
                    ...
                    <div className="d-flex justify-content-center align-items-center mb-4">
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">VS Code</small>
                        </div>
                        <div className="d-flex flex-column">
                            <img className="img-fluid mx-3" src="https://skillicons.dev/icons?i=github" alt="github" />
                            <small className="text-center text-secondary fw-bold">Github</small>
                        </div>
                        <div className="d-flex flex-column align-self-end">
                            ...
                            <small className="text-center text-secondary fw-bold">Git Bash</small>
                        </div>
                        <div className="d-flex flex-column">
                            <img className="img-fluid mx-3 zustand" src={saplogon} alt="sap logon" />
                            <small className="text-center text-secondary mt-1 fw-bold">SAP Logon</small>
                        </div>
                    </div>
                    <div className="d-flex justify-content-center align-items-center mb-4">
                        <div className="d-flex flex-column">
                            <img className="img-fluid mx-4 abap" src={netbeans} alt="netbeans" />
                            <small className="text-center text-secondary fw-bold">NetBeans</small>
                        </div>
                        <div className="d-flex flex-column align-self-end">
                            <img className="img-fluid mx-3 abap" src="https://skillicons.dev/icons?i=androidstudio" alt="android studio" />
                            <small className="text-center text-secondary fw-bold">Android Studio</small>
                        </div>
                        <div className="d-flex flex-column">
                            <img className="img-fluid mx-2 abap" src={jira} alt="jira" />
                            <small className="text-center text-secondary fw-bold">Jira</small>
                        </div>
                        <div className="d-flex flex-column">
                            ...
                            <small className="text-center text-secondary fw-bold">Photoshop</small>
                        </div>
                    </div>
                </div>
            </div>
